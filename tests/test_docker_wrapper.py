...
#     with create_container("mysql", ports={"4306/tcp": 3306}, env={"MYSQL_ROOT_PASSWORD": "12345"}) as container:
...
#     port = 4200
#     with pytest.raises(RuntimeError) as execinfo:
#         with create_container("crate", ports={"6200/tcp": port}):
#             with create_container("crate", ports={"6200/tcp": port}) as container2:
